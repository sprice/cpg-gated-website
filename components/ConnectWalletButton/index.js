...
export default function ConnectWalletButton(props) {
  ...
  if (state.address) {
    return (
      <div>
        ...
        <button
          type="button"
          className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-extralight font-cpg rounded-md shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
          onClick={async () => {
            await fetch("/api/logout");
            disconnectWallet();
            setState({});
  ...
  return (
    <>
      ...
      <button
        type="button"
        className="inline-flex items-center px-4 py-2 border border-cpg-red text-sm font-extralight font-cpg rounded-md shadow-sm text-white bg-cpg-red hover:bg-cpg-red focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cpg-red"
        onClick={openModal}
      >
        Connect Wallet
      </button>
